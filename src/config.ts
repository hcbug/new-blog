...
export const siteConfig: SiteConfig = {
	title: "洪畅的博客",
	subtitle: "想，全是问题；做，才有答案。",
	siteURL: "https://blog.hcbu.cn/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-04", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "hcbug", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "3546923357178301", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
		fetchOnDev: false, // 是否在开发环境下获取 Bilibili 数据（默认 false）
		coverMirror: "https://t.alcy.cc/fj", // 封面图片镜像源（可选，如果需要使用镜像源，例如 "https://images.weserv.nl/?url="）
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/hcbug",
					external: true,
					icon: "simple-icons:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3546923357178301",
					external: true,
					icon: "simple-icons:bilibili",
				},
				{
					name: "Youtube",
					url: "https://youtube.com/@hcbug",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo-api-ecru-seven.vercel.app",
		lang: SITE_LANG,
	},
	giscus: {
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://api.injahow.cn/meting/?type=playlist&id=2619366284", // Meting API 地址
	id: "2619366284", // 歌单ID
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "<p>Copyright © 2026 洪畅. All Rights Reserved.</p>", // HTML格式的自定义页脚信息，例如备案号等，默认留空
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Hong Chang's blog!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/hcbug", // 关于链接
	},
};
