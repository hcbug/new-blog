	...
	// #region 网上邻居 since 2026-07-02
	{
		...
		entries: [
			...
			},
			{
				...
				feed: 'https://blog.andyjin.website/atom.xml',
				avatar: 'https://filestorage0.oss-cn-hongkong.aliyuncs.com/avatar.png',
				icon: 'https://blog.andyjin.website/img/fluid.png',
				archs: ['Hexo', 'Python'],
				date: '2026-07-11',
